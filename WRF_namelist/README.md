...
# WRF test cases namelist examples
1. Several test cases with ECONUS domain or nested domain is simulated with the test namelists.
2. IC/BC is provided by ERA5 datasets. 
